...
const AceBanner = () => (
  <div className="hb-root hb-ace">
    <div className="hb-left">
      ...
      <p className="hb-body">
        The 2026 Selective Ace collection is here — every tier backed by
        crystal-clear standards and absolute precision.
      </p>
...
const QueenBanner = () => (
  <div className="hb-root hb-queen">
    <div className="hb-left">
      ...
      <h2 className="hb-headline hb-headline-queen">
        Grace is not given.
        <br />
        It is earned.
      </h2>
      <p className="hb-body hb-body-queen">
        The Queen's Grace collection celebrates those who lead with elegance —
        every detail woven in rose gold and quiet confidence.
      </p>
...
const KingBanner = () => (
  <div className="hb-root hb-king">
    <div className="hb-left">
      ...
      <h2 className="hb-headline hb-headline-king">
        Rule the room.
        <br />
        Own the moment.
      </h2>
      <p className="hb-body hb-body-king">
        The King's Command collection stands apart — authoritative, minimal, and
        built for those who need no introduction.
      </p>
...
const ROWS: RowData[] = [
  {
    tier: "CONCEPT 3",
    subtitle: "SELECTIVE ACE",
    banner: <AceBanner />,
    cards: aceCards,
  },
  {
    tier: "CONCEPT 2",
    subtitle: "REFINED QUEEN",
    banner: <QueenBanner />,
    cards: queenCards,
  },
  {
    tier: "CONCEPT 1",
    subtitle: "AUTHORITATIVE KING",
    banner: <KingBanner />,
    cards: kingCards,
  },
];
